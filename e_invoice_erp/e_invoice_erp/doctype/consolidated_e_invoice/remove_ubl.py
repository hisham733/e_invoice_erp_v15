...
@frappe.whitelist()
def remove_signature_and_ublextensions_consolidated(document_info):
    try:
        ...
        file_path = "home/frappe/frappe-bench/apps/e_invoice_erp/e_invoice_erp/e_invoice_erp/doctype/consolidated_e_invoice/consolidated_out_invoice.json"
        ...
        cleaned_json_str = json.dumps(
            cleaned_data, separators=(",", ":"), ensure_ascii=False
        )
